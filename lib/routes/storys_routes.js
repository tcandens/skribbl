...
var trace = require('../bin/trace_story.js');
...
module.exports = function(router){
  ...
  //router.get('/storys/:num?', function(req, res) {
    //var limit;
    ...
    //} else if ( req.params.num <= 0 ) {
      //limit = 1;
    //}
    //Skribbl.find({parent_skribbl: null}, null, {limit: limit} ,function(err, storys){
      //if(err) {
        //console.log(err);
        //return res.status(500).json( [] );
      //}
